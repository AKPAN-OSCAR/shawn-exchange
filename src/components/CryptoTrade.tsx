...
import { TRANSACTION_STATUS, TRANSACTION_TYPES, RATE_LOCK_TIME } from '../constants';
...
export const CryptoTrade: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  const WALLET_ADDRESS = "TD7wK8U3XvS7qMhQ2vP8nZ9L5fR2T4B9vE"; // Shawn TRC20 Wallet
              ...
              <div className="card-premium bg-primary text-white">
                <div className="flex justify-between items-center mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-white/60">{mode === 'sell' ? 'Shawn Buys @' : 'Shawn Sells @'}</p>
