...
export const Maintenance: React.FC = () => {
  return (
    <div className="min-h-screen bg-primary flex flex-col items-center justify-center p-6 text-center">
      ...
      >
        Shawn Exchange is currently undergoing scheduled maintenance or has been disabled. Access to the dashboard and trading features is temporarily unavailable.
      </motion.p>
